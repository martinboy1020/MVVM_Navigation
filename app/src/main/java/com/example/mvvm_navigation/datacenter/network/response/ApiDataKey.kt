...
object ApiDataKey {
    ...
    const val HOME_RANK = "homeRank"
    const val AWAY_RANK = "awayRank"
    ...
    const val FUTURE_MATCHES = "futureMatches"
    const val LEAGUE_MATCHES = "futureMatches"
    const val HOME_MATCHES = "homeMatches"
    const val AWAY_MATCHES = "awayMatches"
    const val WIN = "win"
    const val LOST = "lost"
    const val TIE = "tie"
    ...
    const val AWAY_MANAGER = "awayManager"
    const val HOME_FORMATION = "homeFormation"
    const val AWAY_FORMATION = "awayFormation"
    const val FIRST = "first"
    const val SHIRT_NUMBER = "shirtNumber"
    const val POSITION_X = "x"
    const val POSITION_Y = "y"
    const val TG_ODDS = "tgOdds"
    const val ODDS = "odds"
    const val ASIA = "asia"
    const val EU = "eu"
    const val BS = "bs"
