...
class MatchListContract {
    interface ModelImpl {
        ...
        fun setMatchItemToTopList(data: MatchList.Match, pageType: Int): MutableList<MatchList.Match>
        suspend fun getMatchesList(date: Long, pageType: Int): HttpResult<HttpStatus<MatchList.Data>>
